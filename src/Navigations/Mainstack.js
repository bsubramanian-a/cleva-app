...
import EditPlanBEmergencyFund from '../screens/SwiperScreens/EditPlanBEmergencyFund';
import EditDebtonateDebt from '../screens/SwiperScreens/EditDebtonateDebt';
...
const Mainstack = (Drawer, userData) => {
  return (
    <Drawer.Navigator
      ...
      <Drawer.Screen name="EditPlanBEmergencyFund" component={EditPlanBEmergencyFund} />
      <Drawer.Screen name="EditDebtonateDebt" component={EditDebtonateDebt} />
      <Drawer.Screen
